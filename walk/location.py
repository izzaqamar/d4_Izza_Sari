...
class Location:
    def __init__(
        self, pentagon_pos=20, audmax_pos=50, kaia_pos=80, p_pentagon=0.5, p_kaia=0.5
    ):
        ...
        if not (
            ...
            raise ValueError(
                "Positions must satisfy: 0 < Pentagon < AudMax < Kaia < 100"
            )
    ...
    def description(self):
        return (
            f"Pentagon at {self.pentagon_pos} (p={self.p_pentagon}), "
